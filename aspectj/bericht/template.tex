...
\usepackage[
	...
	pdftitle = {Aspektorientierte Programmierung (AOP) mit AspectJ},	   	% PDF-property
	pdfauthor = {aescd5; knece1},        					  % PDF-property
	pdfsubject = {Informatikseminar Bericht 1},        % PDF-property
